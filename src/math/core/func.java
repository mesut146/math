...
public abstract class func
{
	...
	public final func get(String v, double d){
		//System.out.println("fget(v,d)="+v+","+d);
		return get(new Variable(v),new Constant(d));
	}
	...
	public List<Variable> vars(){
		//System.out.println("vars:"+this.getClass()+" ab="+a+" "+b);

		List<Variable> list=new ArrayList<>();
		if(this instanceof Variable){
			list.add((Variable) this);
		}else {
			if(a!=null){
				list.addAll(a.vars());
			}
    ...
    public final func derivative(){return derivative(Variable.x);}
    public abstract func derivative(Variable v);
    public final func derivative(String s){return derivative(new Variable(s));}
    ...
    public func add(func f){
        return new add(this,f).simplify();
    }
	public func add(double d){ return new add(this,new Constant(d)).simplify(); }
    ...
    public func pow(func f){ return new pow(this,f).simplify(); }
    ...
    public String top(){
		...
		if(this instanceof Variable){
			return toString();
		}else if(this instanceof Constant && !(this instanceof Consfunc)){
			return toString();
		}
        return "("+toString()+")";
    }
	...
	public static func parse(String s,Object ...p){
		//System.out.println("s="+s);
		return Parser.parse(String.format(s,p)).simplify();
	}
